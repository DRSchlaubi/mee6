        ...
        commands = [
            {
                ...
                'description': 'Gibt dir Informationen über ein animu.'
            },
            {
                'name': '!mango <mango_name>',
                'description': 'Gibt dir Informationen über ein mango.'
            }
        ]
        return commands
    ...
    async def on_message(self, message):
        ...
        if data == '':
            await self.mee6.send_message(
                message.channel,
                'Ich habe nichts gefunden, sorry :cry: ...'
            )
            return
        ...
        if len(root) == 0:
            ...
            msg = "**Bitte gebe mir die Zahl des richtigen Eintrags.**\n"
